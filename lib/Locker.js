(function(module) {
    ...
    function Locker(port, host) {
        ...
        self.createLock = function(name, origin) {
            var sequence = ++this.sequence,
                acquire  = this.acquire,
                release  = this.release,
                registry = this.registry,
                lock     = new Lock(name, origin, sequence, acquire, release);
    ...
    Locker.prototype.locked = function(name, origin, wait, timeout, callback) {
        var self = this,
            lock = self.createLock(name, origin);
